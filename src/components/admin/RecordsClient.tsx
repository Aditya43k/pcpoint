...
const statuses: ServiceRequest['status'][] = ['Pending', 'Scheduled', 'Declined', 'In Progress', 'Awaiting Parts', 'Completed', 'Cancelled', 'Paid'];
...
export function RecordsClient() {
  ...
  const { data: allRequests, isLoading, error } = useCollection<ServiceRequest>(serviceRequestsQuery);
  ...
  const currentBrands = filters.deviceType ? deviceBrands[filters.deviceType as keyof typeof deviceBrands] : [];
